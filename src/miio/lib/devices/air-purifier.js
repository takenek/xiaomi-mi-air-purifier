		...
		SwitchableLED, LEDBrightness, Buzzer, FanSpeed)
{
	 ...
	 */
	changeMode(mode) {
		// NOTE: Temporary fix to handle `none` mode
		// https://miot-spec.org/miot-spec-v2/spec/property?type=urn:miot-spec-v2:property:mode:00000008 
		if (mode === 'none') {
			return Promise.resolve(this.property('mode'));
		}
